...
class CoroutinesFragment : Fragment() {
    ...
    suspend fun myJobbFunc() {
        for (i in 1..10000) {
            // This is NOT running in the main thread
            Log.i(MainActivity.APP_TAG, "RUTINA2 $i in ${Thread.currentThread().name}")
            ...
            // Switch to main thread to update view
//            withContext(Dispatchers.Main) {
//                binding.messageTextView.text = "RUTINA user $i"
//            }
            delay(100)
        }
    }
